...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-클릭하여_24시간_체험하기-6366f1?style=for-the-badge&logo=vercel&logoColor=white)](https://mind-anchor-seven.vercel.app/)
...
## 🌐 심사위원용 24시간 실시간 라이브 데모 (Live Demo)

> 🔗 **무제한 체험 링크**: [https://mind-anchor-seven.vercel.app/](https://mind-anchor-seven.vercel.app/)
>
> 📌 **안내 사항**:
> 1. 내 컴퓨터가 꺼져 있어도 전 세계 어디서나 24시간 무제한 접속이 가능합니다.
> 2. 네이비색 다크 테마의 **인지 건강 관제 대시보드**가 바로 구동되며, 실시간 Vapi AI 음성 안부 대화, 4대 신경언어학적 인지 건강 지표 측정 및 종합 소견 리포트 기능을 체험하실 수 있습니다.
